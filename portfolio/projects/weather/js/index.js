...
// Obtain the User's Geolocation with Google API:
window.onload = function() {
  ...
  var geoSuccess = function(position) {
    ...
    var url = "http://api.openweathermap.org/data/2.5/weather?" + "lat=" + lat + "&lon=" + lon + "&APPID=e75aa9eb22e3e903ba187251f2faa34f";
    ...
    $.getJSON(url, function (data) {
      ...
      document.getElementById("weather").innerHTML = "The current weather in your location is " + weather + ", with a temperature of " + Math.round(fahrenheit) + "°F";
      ...
      $('#kelvin').click(function() {
        document.getElementById("weather").innerHTML = "The current weather in your location is " + weather + ", with a temperature of " + Math.round(kelvin) + "K";
      });
      
      $('#celsius').click(function() {
        document.getElementById("weather").innerHTML = "The current weather in your location is " + weather + ", with a temperature of " + Math.round(celsius) + "°C";
      });
